...
extension Workspace {
    ...
    private func sessionPanelSnapshot(
        ...
        let listeningPorts: [Int] = (surfaceListeningPorts[panelId] ?? []).sorted()
...
final class Workspace: Identifiable, ObservableObject {
    ...
    func sidebarFinderDirectory() -> String? {
        ...
        return sidebarDirectoriesInDisplayOrder(orderedPanelIds: panelIds, includeFallback: true).first
    }
    ...
    func newTerminalSplit(
        ...
        let effectiveStartupEnvironment = startupEnvironment
    ...
    func splitPaneWithNewTerminal(
        ...
        let effectiveStartupEnvironment: [String: String] = [:]
        if startupCommand != nil {
            var template = inheritedConfig ?? CmuxSurfaceConfigTemplate()
            template.waitAfterCommand = true
            inheritedConfig = template
